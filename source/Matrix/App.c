...
//18 pixeles (72*6 +1)
	...
	//18 pixeles (72*6 +1)
		...
		//18 pixeles (72*6 +1)
				...
				DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,
				DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,
				DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO,DUTY_ZERO //10 pizeles
};
...
void App_Run (void) {
	...
	gpioMode(PORTNUM2PIN(PC,1), OUTPUT);

	gpioWrite(PORTNUM2PIN(PC,1), LOW);

	pitSetIRQFunc(PIT_1, dma_start);
	pitSetAndBegin(PIT_1, 60);
